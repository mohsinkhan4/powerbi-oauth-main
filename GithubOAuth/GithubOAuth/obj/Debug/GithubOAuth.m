...
client_id = "89d46bd7275c41449358";
client_secret = "d4c43c7722cf0129c543da326a6bc6b2d633a916";
...
[DataSource.Kind="GithubOAuth", Publish="GithubOAuth.UI"]
shared GithubOAuth.Contents = Value.ReplaceType(Github.Contents, type function (url as Uri.Type) as any);

[DataSource.Kind="GithubOAuth"]
shared GithubOAuth.PagedTable = Value.ReplaceType(Github.PagedTable, type function (url as Uri.Type) as nullable table);
...
GithubOAuth.UI = [
    ...
    SourceImage = GithubOAuth.Icons,
    SourceTypeImage = GithubOAuth.Icons
];
